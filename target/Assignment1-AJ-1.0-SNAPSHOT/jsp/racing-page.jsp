...
<form action="${pageContext.request.contextPath}/Servlet3" method="get" style="margin: auto; width: 30%; margin-top: 5%">
    ...
    <button class="btn btn-primary" type="submit" style="margin-top: 5%;width: 100%">go to buy Assetto Corsa</button>
</form>
<form action="${pageContext.request.contextPath}/Servlet3" method="get"  style="margin: auto; width: 30%; margin-top: 10%">
    ...
    <button class="btn btn-primary" type="submit" style="margin-top: 5%;width: 100%">go to buy Need for Speed</button>
</form>
<form action="${pageContext.request.contextPath}/Servlet3" method="get"  style="margin: auto; width: 30%; margin-top: 10%">
    ...
    <button class="btn btn-primary" type="submit" style="margin-top: 5%;width: 100%;margin-bottom: 5%">go to buy Project Cars 2</button>
</form>
